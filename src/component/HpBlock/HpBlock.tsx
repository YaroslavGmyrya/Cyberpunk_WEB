        ...
        <>
            ...
            <div className={styles.HpCol2}>
                ...
                <div className={styles.list}>
                    ...
                    <CustomItem imageName='color.png' color='black'>Яркие насыщенные цвета</CustomItem>

                    <CustomItem imageName='star.png' color='black'>Кристальная четкость изображения</CustomItem>

                    <CustomItem imageName='frame.png' color='black'>Быстрые движения и плавный геймплей</CustomItem>
