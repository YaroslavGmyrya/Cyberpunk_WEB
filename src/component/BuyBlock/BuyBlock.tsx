            ...
            <div className={styles.buyGame}>
                ...
                <div className={styles.gameSet}>
                    <div className={styles.setDescription}>В комплект входит</div>
                        ...
                        <CustomItem imageName='disk.png' color='white' >Футляр с игровыми дисками</CustomItem>
                        <CustomItem imageName='handbook.png'color='white'>Футляр с кодом для загрузки игры и дисками (pc)</CustomItem>
                        <CustomItem imageName='case.png'color='white'>Справочник с информацией об игровом мире</CustomItem>
